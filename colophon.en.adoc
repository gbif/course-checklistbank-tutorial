...
image::img/logos/col_logo.svg[Catalogue of Life logo,width=25%,height=25%,align=center]
image::img/logos/normal-reproduction-low-resolution.jpg[EU flag,width=25%,height=25%,align=center]
image::img/logos/gbif-standard-logo-green.png[GBIF logo,width=25%,height=25%,align=center]
