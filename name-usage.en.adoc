...
Step 3: Click on the Scientific Name (Quercus robur Asso) for the Dataset ‘World Flora Online consortium’.
...
This brings you to the information page about this name of the original source checklist.

image::img/web/Quercus-WFO.png[align=center]

This example shows that by using the 'cross dataset search' tool, you can make linkages to other data providers to explore further evidence of a scientific name.
